...
export default function RatingStar({ queryConfig }: PropsTypes) {
      ...
      {Array(5)
        ...
        .map((_, index) => (
          <li className='py-1 pl-2' key={index}>
            <div
              className='flex items-center text-sm gap-x-1 cursor-pointer'
            ...
            >
              ...
              <span className='ml-2 text-[15px]'>{index != 0 && 'trở lên'}</span>
            </div>
          </li>
        ))}
    </ul>
